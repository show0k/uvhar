                          ...
                          gpointer    data )
{
  ...
  ARDRONE_CONFIGURATION_SET(enemy_colors, pos + 1 );
                           ...
                           gpointer    data )
{
  ...
  ARDRONE_CONFIGURATION_SET(flight_without_shell, (pos==0)?TRUE:FALSE );
}
    ...
    button_ShowCurve[k] = gtk_check_button_new_with_label(ihm_CA[k].ctrl_lbl);
...

	  {
        ...
        ldata = vp_os_malloc(sizeof(private_data_led));
		  ...
		  gtk_combo_box_insert_text( (GtkComboBox*)combo, 0, (const gchar*)"Cam. hor.");
		  gtk_combo_box_insert_text( (GtkComboBox*)combo, 1, (const gchar*)"Cam. vert.");
		  gtk_combo_box_insert_text( (GtkComboBox*)combo, 2, (const gchar*)"2D tags");
...
#define ADD_ANIMATION_COMBO(x) \
		  gtk_combo_box_insert_text( (GtkComboBox*)combo, x, (const gchar*)#x);

		  ADD_ANIMATION_COMBO(ANIM_PHI_M30_DEG);
		  ADD_ANIMATION_COMBO(ANIM_PHI_30_DEG);
		  ADD_ANIMATION_COMBO(ANIM_THETA_M30_DEG);
		  ADD_ANIMATION_COMBO(ANIM_THETA_30_DEG);
		  ADD_ANIMATION_COMBO(ANIM_THETA_20DEG_YAW_200DEG);
		  ADD_ANIMATION_COMBO(ANIM_THETA_20DEG_YAW_M200DEG);
		  ADD_ANIMATION_COMBO(ANIM_TURNAROUND);
		  ADD_ANIMATION_COMBO(ANIM_TURNAROUND_GODOWN);
		  ADD_ANIMATION_COMBO(ANIM_YAW_SHAKE);
